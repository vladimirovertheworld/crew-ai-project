...
if ! git push -u origin main; then
    ...
    git pull origin main --rebase || handle_error "Failed to pull remote changes"
    git push -u origin main || handle_error "Failed to push to 'main' branch after pulling remote changes"
    echo -e "${GREEN}Successfully pushed to 'main' branch after resolving conflicts.${NC}"
else
